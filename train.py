...
def main():
    ...
    # check_if_training_in_process(output_dir)
    ...
    try:
        ...
        train_counts, train_pos_counts = get_sample_counts(output_dir, datasets["train"], class_names)
        dev_counts, _ = get_sample_counts(output_dir, datasets["val"], class_names)
